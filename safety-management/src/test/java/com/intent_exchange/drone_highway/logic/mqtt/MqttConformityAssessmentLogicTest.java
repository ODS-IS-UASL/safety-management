...
import com.intent_exchange.drone_highway.dto.request.NotifyConformityAssessmentResultDto;
...
class MqttConformityAssessmentLogicTest {
  ...
  @Test
  @DisplayName("運航中航路状況変更通知を外部システム連携(A-1-6)に送信する")
  public void testNotifyConformityAssessment1() {
    ...
    reqDto.setAirwayReservationId("airwayReservationId");
