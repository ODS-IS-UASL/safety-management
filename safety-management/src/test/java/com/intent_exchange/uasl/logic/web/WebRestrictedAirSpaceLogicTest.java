...
/**
 * 空域デジタルツイン 規制/イベント情報への通信用ロジックのテストクラス。
 */
...
class WebRestrictedAirSpaceLogicTest {
  ...
  public void setUp() throws Exception {
    ...
    String testRestrictedAirSpaceUrlUrl = PropertyUtil.getProperty("post.restricted.air.space.url");
    Field restrictedAirSpaceUrlField =
        WebRestrictedAirSpaceLogic.class.getDeclaredField("postRestrictedAirSpaceUrl");
    restrictedAirSpaceUrlField.setAccessible(true);
    restrictedAirSpaceUrlField.set(logic, testRestrictedAirSpaceUrlUrl);
  }
