...
/**
 * UaslDesignAreaInfoOperationLogicのテストクラス。
 */
@ExtendWith(MockitoExtension.class)
class UaslDesignAreaInfoOperationLogicTest {

  @Mock
  private UaslDesignAreaInfoOperationMapper mapper;

  @InjectMocks
  private UaslDesignAreaInfoOperationLogic logic;
  ...
  void testGet() {
    ...
    List<UaslDesignAreaInfoOperation> list = new ArrayList<>();
