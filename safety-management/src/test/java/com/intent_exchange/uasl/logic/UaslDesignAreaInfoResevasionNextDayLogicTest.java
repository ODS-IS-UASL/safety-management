...
/** UaslDesignAreaInfoResevasionNextDayLogicのテストクラス。*/

// TestConfigとModelMapperConfigのModelMapperインスタンス作成のbeenが重複してエラーのため、Bean 定義の上書きを許可します。
@SpringBootTest(properties = "spring.main.allow-bean-definition-overriding=true")
class UaslDesignAreaInfoResevasionNextDayLogicTest {
  ...
  @InjectMocks
  private UaslDesignAreaInfoResevasionNextDayLogic logic;
  ...
  void testGet1() {
    // 航路情報取得条件の取得の実行
    List<UaslDesignAreaInfoReservation> result = mapper.selectNextDay();
