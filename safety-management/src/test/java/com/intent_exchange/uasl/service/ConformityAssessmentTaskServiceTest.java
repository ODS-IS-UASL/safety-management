...
class ConformityAssessmentTaskServiceTest {
  ...
  @Mock
  private IFUaslDesignAreaInfoLogic logic;
  ...
  void testConformityAssessmentOperation() {
    ...
    when(context.getBean(IFUaslDesignAreaInfoLogic.class)).thenReturn(logic);
    ...
    assertDoesNotThrow(
        () -> service.conformityAssessment(dto, IFUaslDesignAreaInfoLogic.class, prcClazz));
